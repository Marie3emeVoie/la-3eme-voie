  ...
  const Testimonial = ({ quote, author }) => (
    <div className="relative border-t-8 border-l-2 border-r-2 border-b-2 border-gray-300 p-6 mt-8 bg-white" 
      ...
      <div className="absolute -top-4 left-4 w-8 h-8 bg-white border-2 border-gray-300 rounded-full flex items-center justify-center transform">
        <div className="grid grid-cols-2 gap-0 text-xs font-bold text-gray-600">
          <span style={{ lineHeight: '0.8', textAlign: 'left' }}>66</span>
          <span style={{ lineHeight: '0.8', textAlign: 'right' }}>99</span>
        </div>
      </div>
      <blockquote className="text-lg italic" style={{ color: '#405449' }}>
        "{quote}"
      </blockquote>
      <cite className="block text-right mt-4 font-bold" style={{ color: '#3B4540' }}>
        – {author}
      </cite>
    </div>
  );
...
const slides = [
              ...
              {slides.map((slide, index) => {
                ...
                return (
                  <div
                    key={index}
                    onClick={() => onSelect(index)}
                    className={`flex items-center cursor-pointer rounded-lg text-xs hover:bg-gray-100 ${
        ...
        return (
          <div className="flex flex-col md:flex-row overflow-hidden rounded-lg">
            ...
            <div className="w-full md:w-1/2 p-8 flex flex-col justify-center" style={{ backgroundColor: '#FAFFFA' }}>
              <h1 className="font-bold mb-4 text-5xl" style={{ color: '#3B4540' }}>
        ...
        return (
          <div className="flex flex-col md:flex-row overflow-hidden rounded-lg" style={{ backgroundColor: '#FAFFFA' }}>
            <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
              <h2 className="text-3xl font-bold mb-4" style={{ color: '#3B4540' }}>
                Qui suis-je?
              </h2>
      ...
      case 2: // Card 3 - Le choix impossible des parents
        return (
          <div className="p-8" style={{ backgroundColor: '#FAFFFA' }}>
            <h2 className="text-3xl font-bold mb-8 text-center" style={{ color: '#3B4540' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="bg-white p-6 rounded-2xl border-2" style={{ borderColor: '#4A644E' }}>
                  <h3 className="text-xl font-bold mb-4" style={{ color: '#3B4540' }}>
                    {item.title}
                  </h3>
      ...
      case 5: // Card 4a - Un apprentissage serein
        return (
          <div className="flex flex-col md:flex-row h-[400px]" style={{ backgroundColor: '#FAFFFA' }}>
            <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
              <h2 className="text-3xl font-bold mb-4 text-left" style={{ color: '#3B4540' }}>
            ...
            <div className="w-full md:w-1/2 p-8 flex items-center justify-center">
              <div className="w-full h-48 rounded-2xl flex items-center justify-center text-xl" 
              ...
              {whoIAccompany.map((item, idx) => (
                <div key={idx} className="bg-white p-6 rounded-2xl">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold ml-3" style={{ color: '#3B4540' }}>
                      {item.title}
                    </h3>
                  </div>
                  <p style={{ color: '#405449' }}>
                  ...
                  <div key={idx}>
                    ...
                    <ul className="space-y-2">
                      {service.items.map((item, itemIdx) => (
                        <li key={itemIdx} style={{ color: '#405449' }}>
                          • {item}
                        </li>
                      ))}
                    </ul>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {pillars.map((pillar, idx) => (
                <div key={idx} className="text-center">
                  <h3 className="text-lg font-bold mb-2" style={{ color: '#3B4540' }}>
                    {pillar.title}
                  </h3>
                  <p className="text-sm" style={{ color: '#405449' }}>
                    {pillar.desc}
                  </p>
                </div>
              ))}
  ...
  return (
    <div
      className={`relative min-h-screen transition-opacity duration-500 ease-in-out ${presentMode ? 'bg-white' : 'bg-[#DEEEE1]'}`}
    >
      <style>
        {`
