...
<section id="my-role-section" className="w-full mb-10">
  <Card className="p-6 custom-shadow w-full" style={{ backgroundColor: '#FAFFFA' }}>
    <CardContent className="flex flex-col md:flex-row items-center gap-8">
      <div className="md:w-1/2">
        <img
...
<section id="who-i-accompany" className="w-full mb-10">
  <Card className="p-6 custom-shadow w-full min-h-[200px]" style={{ backgroundColor: '#FAFFFA' }}>
    <CardContent>
...
<section id="five-pillars-section" className="w-full mb-10">
  <Card className="p-6 custom-shadow w-full" style={{ backgroundColor: '#FAFFFA' }}>
    <CardContent className="flex flex-col md:flex-row items-center gap-8">
      <div className="md:w-1/2">
...
<section id="testimonials-section" className="w-full mb-10">
  <Card className="p-6 custom-shadow w-full min-h-[200px]" style={{ backgroundColor: '#FAFFFA' }}>
    <CardContent>
...
// Card 12: Capsules Pédagogiques Section
<section id="capsules-banner" className="w-full mb-10">
  <Card className="p-6 custom-shadow w-full text-center min-h-[150px]" style={{ backgroundColor: '#C1EBE2' }}>
    <CardContent>
      <h2 className="text-4xl font-extrabold mb-4" style={{ color: '#3B4540' }}>Découvrez nos capsules éducatives !</h2>
...
<aside className="fixed top-0 left-0 h-full w-64 bg-[#438951] text-white p-6">
  <nav>
    <ul>
      <li><a href="#hero-section" className="block py-2 hover:text-[#C1EBE2]">Accueil</a></li>
      <li><a href="#about-me-section" className="block py-2 hover:text-[#C1EBE2]">Qui suis-je ?</a></li>
      <li><a href="#impossible-choice-section" className="block py-2 hover:text-[#C1EBE2]">Le choix impossible</a></li>
      <li><a href="#third-way-principles" className="block py-2 hover:text-[#C1EBE2]">La 3e Voie</a></li>
      {/* Continue with other section links */}
    </ul>
  </nav>
</aside>

// Footer Section (Replace Instagram with YouTube)
<footer className="w-full p-6 bg-[#438951] text-white text-center">
  <div className="container mx-auto">
    <p className="text-xl font-bold mb-4">La 3ème Voie Éducative</p>
    <p className="text-lg">© 2025 Tous droits réservés | Créé avec soin pour les enfants atypiques</p>
    <div className="mt-4">
      <a href="https://www.facebook.com" className="text-white mx-2 hover:text-gray-300 transition-colors">
        <i className="fab fa-facebook"></i>
      </a>
      <a href="https://www.youtube.com" className="text-white mx-2 hover:text-gray-300 transition-colors">
        <i className="fab fa-youtube"></i>
      </a>
      <a href="https://www.linkedin.com" className="text-white mx-2 hover:text-gray-300 transition-colors">
